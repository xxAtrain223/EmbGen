        ...
        namespace test
        {
            TEST(embgen_EmbGen, no_appendages)
            {
                ...
                ASSERT_EQ(embGen.generateSource(),
                    ...
                    "\n"
                    "SerialBuffer<64> buffer(&Serial);\n"
                    "extern emb::device::EmbMessenger<0> myMessenger;\n"
                    "\n"
                    "void setup()\n"
                    "{\n"
                    "    Serial.begin(9600);\n"
                    ...
                    "};\n"
                    "\n"
                    "emb::device::EmbMessenger<0> myMessenger(&buffer, commands, 1u);\n"
                    "\n"
                );
            ...
            TEST(embgen_EmbGen, Command)
            {
                ...
                ASSERT_EQ(embGen.generateSource(),
                    ...
                    "};\n"
                    "\n"
                    "emb::device::EmbMessenger<0> myMessenger(&buffer, commands, 3u);\n"
                    "\n"
                );
            ...
            TEST(embgen_EmbGen, Stop)
            {
                ...
                ASSERT_EQ(embGen.generateSource(),
                    ...
                    "};\n"
                    "\n"
                    "emb::device::EmbMessenger<0> myMessenger(&buffer, commands, 2u);\n"
                    "\n"
                );
            ...
            TEST(embgen_EmbGen, Everything)
            {
                ...
                ASSERT_EQ(embGen.generateSource(),
                    ...
                    "\n"
                    "const emb::device::EmbMessenger<>::CommandFunction commands[] PROGMEM = {\n"
                    "    Everything_get_adaptor,\n"
                    "    Everything_set_adaptor,\n"
                    "    Everything_zero_adaptor,\n"
                    "    Everything_stop,\n"
                    "    all_stop\n"
                    "};\n"
                    "\n"
                    "emb::device::EmbMessenger<0> myMessenger(&buffer, commands, 5u);\n"
                    "\n"
                );
